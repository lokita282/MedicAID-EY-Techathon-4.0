...
ctmodel_path = '/models-h5/ct-scan/chest_CT_SCAN-DenseNet201.hdf5'
ctmodel = load_model(os.path.join(absolute_path, ctmodel_path))

# Load the MRI model
mrimodel_path ='/models-h5/MRI/VGG16-Brain-Tumor-MRI-3.h5'
mrimodel = load_model(os.path.join(absolute_path, mrimodel_path))

# Load the pneumonia model
pneumonia_path = '/models-h5/PNEUMONIA/pneumonia_model.h5'
pneumonia_model = load_model(os.path.join(absolute_path, pneumonia_path))

# Load the Cancer model
cancerModel = load_model("models-h5\LUNG-CANCER\lung cancer_final_99.h5")
