      ...
      {loading ? (
        ...
        <Box>
          <Box sx={{ display: 'flex' }}>
            ...
            />
            <Typography sx={{ ...bold_name, marginBottom: '3%' }}>
            ...
            <Grid item md={3} xs={12}>
              ...
              {cat
                .filter((item) => {
                  ...
                  return (
                    endsAt.isAfter(currentDate) &&
                    moment(item.startsAt).isBefore(currentDate) &&
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        {ca.balanceAmount && (
                          <p
                            style={{ ...ptag, fontSize: '11px', padding: '5%' }}
                          >
            ...
            <Grid item md={3} xs={12}>
              ...
              {cat
                .filter((item) => {
                  ...
                  return (
                    startsAt.isAfter(currentDate) && item.status === 'upcoming'
                  )
                })
                .map((ca, i) => {
                  return (
            ...
            <Grid item md={3} xs={12}>
              ...
              {cat
                .filter((item) => {
                  const endsAt = moment(item.endsAt)
                  return (
                    endsAt.isBefore(currentDate) && item.status !== 'redeemed'
                  )
                })
                .map((ca, i) => {
                  return (
